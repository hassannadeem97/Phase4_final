module Contexts
  module UserContexts
    def create_users
      @user1 = FactoryBot.create(:user, username: "mheimann", password: "123456", password_confirmation:"123456", role: "admin; instructor", email: "mark@example.com", phone: "1234567890")
      @user2 = FactoryBot.create(:user, username: "aheimann", password: "012345", password_confirmation:"012345", role: "admin", email: "alex@example.com", phone: "1234567809")
      @user3 = FactoryBot.create(:user, username: "hassann", password: "010101", password_confirmation:"010101", role: "instructor", email: "hassann@example.com", phone: "0234567890", active: false)
    end 
    ...
    def create_more_users
      ...
      @user7 = FactoryBot.create(:user, username: "dheimann", password: "2123456", password_confirmation:"2123456", role: "admin; instructor", email: "dm@example.com", phone: "1234567890")
      ...
      @user10 = FactoryBot.create(:user, username: "fheimann", password: "5123456", password_confirmation:"5123456", role: "admin; instructor", email: "f@example.com", phone: "1234567890")
      ...
      @user13 = FactoryBot.create(:user, username: "oheimann", password: "8123456", password_confirmation:"8123456", role: "admin; instructor", email: "o@example.com", phone: "1234567890")
